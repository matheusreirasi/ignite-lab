...
function Video(props: VideoProps) {
    ...
    const {data} = useQuery<GetLessonBySlugResponse>(useGetLessonBySlug, {
        variables: {
    ...
    return (
        <div className="flex-1">
            <div className="bg-black flex justify-center">
                <div className="h-full w-full max-w-[1100px] max-h-[90vh] aspect-video'">
                    <Player>
                ...
                <div className="flex items-start gap-16">
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            ...
                            <div className="leading-relaxing">
